...
class OpenOCDBridge:
    ...
    def _ensure_cfg(
        ...
        *,
        ...
        # Generate a config for ESP32-S3 built-in USB-JTAG style adapters.
        # OpenOCD homebrew ships `adapter driver esp_usb_jtag` but only includes
        # an "esp_usb_bridge.cfg" preset (PID 0x1002). Many ESP32-S3 devkits use
        # a different PID for the built-in USB Serial/JTAG function (often 0x1001),
        # so we generate a small cfg that sets vid/pid explicitly.
        lines = [
            "# Auto-generated by EAB (OpenOCDBridge)",
            f"set CHIPNAME {chip}",
