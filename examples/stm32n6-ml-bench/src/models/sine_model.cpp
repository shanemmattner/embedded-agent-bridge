 ...
 *
 * Int8-quantized sine model from TFLite Micro hello_world sample.
 * Renamed g_model -> g_sine_model for multi-model bench.
 */

#include "sine_model.h"

alignas(8) const unsigned char g_sine_model[] = {
...
const int g_sine_model_len = 2488;
